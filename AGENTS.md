...
This is the **auto-docs** project — a documentation structure specification for organizing project documentation. It defines the standard `docs/` directory layout, naming conventions, and content expectations used across all Automatic-managed projects.
